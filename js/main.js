...
ScrollReveal().reveal('.home .info h2', { delay: 100, origin: 'left' })
...
ScrollReveal().reveal('.skills-description, .services-description, .contact-card, .client-swiper', { delay: 100, origin: 'right' })
ScrollReveal().reveal('.skills-description, .services-description, .contact-card, .client-swiper, .contact-left h2', { delay: 100, origin: 'left' })
ScrollReveal().reveal('.experience-card, .service-card, .education, .portfolio .img-card', { delay: 100, origin: 'bottom', interval: 200 })
