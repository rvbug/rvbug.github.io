...
At the time of writing this paper, I have analyzed metadata of over **10,005** commits across **2000** open source repositories post 2024. This is when we started seeing rapid integration of LLMs in Software Development Lifecycle.
...
1.  No specific repository or author names will be mentioned in this paper particularly those repositories which has been built completely using AI and AI Agents, high entropy or which exhibits **Black Swan**[@vasudevan2024blackswan] events
...
Anomaly Transitions section (where $R^2$ is 0.5432) are **Black Swan** [@vasudevan2024blackswan] events i.e. commits where entropy is so high that even traditional regression model fail. This requires immediate audit.
