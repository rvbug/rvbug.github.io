...
First step is to install Quarto CLI from [quarto.org](https://quarto.org/docs/get-started/).
...
Second, choose the tool. I use [`RStudio`](https://posit.co/download/rstudio-desktop/) but ,my preferred way is to use Quarto on Neovim via a plugin called [`quarto-nvim`](https://github.com/quarto-dev/quarto-nvim)
...
On Neovim, I use a plugin called "Zen mode" for focus mode. Read more about this plugn [here](https://github.com/folke/zen-mode.nvim)
...
::: {.callout-tip}
## Neovim Setup 
If you want to know more about neovim, checkout my [setup](https://github.com/rvbug/neovim)  
:::
...
I have created a `cli` script **Doc2Quarto** to help you with this migration. This is an open source tool. Instructions are available [here](https://github.com/rvbug/doc2quarto).


![Doc2Quarto](img/Doc2Quarto_text_n_logo.png)
...
![CLIPreview](img/Doc2Quarto-cli.png)
...
For more information please checkout my [Github Repo](https://github.com/rvbug/doc2quarto)
