...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, titlerule=0mm, opacitybacktitle=0.6, bottomtitle=1mm, opacityback=0, arc=.35mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, left=2mm, coltitle=black, breakable, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, colback=white]
