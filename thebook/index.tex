...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, arc=.35mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, opacityback=0, toptitle=1mm, breakable, coltitle=black, titlerule=0mm, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm, left=2mm, colback=white]
...
\chapter{Doc2Quarto}\label{doc2quarto-1}
...
\NormalTok{                in\_frontmatter }\OperatorTok{=} \ConstantTok{false}\OperatorTok{;} \CommentTok{// Add this line for clarity}
                \ControlFlowTok{continue}\OperatorTok{;}
            \OperatorTok{\}}
        \OperatorTok{\}}
